...
function checkComplete() {
  for (let _i = 0; _i <  3; _i++) {
    if ((squareArr[_i].innerText == "X" || squareArr[_i].innerText == "O") &&     squareArr[_i].innerText == squareArr[_i + 3].innerText 
    && squareArr[_i].innerText == squareArr[_i + 3].innerText
    && squareArr[_i].innerText == squareArr[_i + 3].innerText) console.log("game is over");
  }
}
